...
public class AtividadeControllerTest {
    ...
    @Test
    @WithMockUser(username = "admin", roles = {"USER", "ADMIN"})
    public void testarCadastrarAtividadeFisicaValidarResponsavelNotNull() throws Exception {
        atividadeFisicaDTO.setResponsavel(null);
    ...
    @Test
    @WithMockUser(username = "admin", roles = {"USER", "ADMIN"})
    public void testarCadastrarAtividadeFisicaValidarContatoNotNull() throws Exception {
        atividadeFisicaDTO.setContato(null);
